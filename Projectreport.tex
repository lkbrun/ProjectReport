...
\paragraph{}
As the previous this also involves setting a header parameter, in this case X-Content-Type-Options should be set to 'nosniff' \cite{no-sniff}. 
...
The information could help an adversary form a plan of attack.
