...
The code presented in listing~\ref{hardcodedpassword} is found in DatabaseAutomaticAccessProvider class file, revealing the hardcoded username and password.
